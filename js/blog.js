...
function drawCards(data) {
  ...
  data.forEach((item, i) => {
    ...
    card.find(".blog-cover").css("background", 'url("img/' + item.image + '") no-repeat center center / cover');
